...
<head>
	...
	<!-- JS -->
	<script src="/afiliados-tramites-padron/resources/core/js/jquery.min.js"></script>
	<script src="/afiliados-tramites-padron/resources/core/js/popper.min.js"></script>
	<script src="/afiliados-tramites-padron/resources/core/js/bootstrap.min.js"></script>
    
    <script src="/afiliados-tramites-padron/resources/core/js/main.js"></script>
    
    <script src="/afiliados-tramites-padron/resources/core/js/solicitudes.js"></script>

    <!-- CSS -->
     <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.6.3/css/all.css">
    
    <link rel="stylesheet" href="/afiliados-tramites-padron/resources/core/css/fonts.css">    
    
    <link rel="stylesheet" href="/afiliados-tramites-padron/resources/core/css/solicitudes.css">
    
    <link rel="stylesheet" href="/afiliados-tramites-padron/resources/core/css/bootstrap.css">
    <link rel="stylesheet" href="/afiliados-tramites-padron/resources/core/css/main.css">
   
    <!-- Datepicker -->
	<link rel="stylesheet" href="/afiliados-tramites-padron/resources/core/css/datepicker.css" />
	<script src="/afiliados-tramites-padron/resources/core/js/bootstrap-datepicker.js"></script>
    ...
    <title>afiliados-tramites-padron</title>
</head>
...
<header id="header">
    ...
    <div class="mainnav">
      <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light" style="z-index: 12">
          <div class="container">
              <a class="navbar-brand" href="/afiliados-tramites-padron"><img src="/afiliados-tramites-padron/resources/core/img/logo.svg" alt="afiliados-tramites-padron"></a>

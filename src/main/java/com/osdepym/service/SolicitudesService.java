...
public interface SolicitudesService {
	...
	ResultadoImportarDTO procesarArchivoXLS(ImportForm form, String fileName, List<AfiliadoImportDTO> afiliados) throws CustomException;
	SPResponseDTO confirmarCargaMasiva(Long idArchivo) throws CustomException;
}
